  ...
  <q-layout class="">
    <q-page-container class="" >
      ...
      <div class="row colpad full-height">
        <div class="col-12 col-sm-6 gt-xs bg-side">
        </div>
        <div class="col-12 col-sm-6 row bg-white">
          <div class="ph pv-2 mt-5 col-12 offset-sm-2 col-sm-8">
            <div class="bg-white " >

              <div style="text-align: center;padding-top: 3px;" v-touch-hold.mouse="ApiRoot" class="mt-3 pb-2">

                <q-img src="/assets/icon.png" spinner-color="white" style="width: 60px;" >
                ...
                <div>
                  <span class="bold text-h5 text-primary">ProManSys</span><br>
                  <small class="text-grey-7">Project Management System</small>
                </div>
              ...
              <q-form class="form-area row" @submit.prevent="login" >
                ...
                <div class="col-12 col-md-12 pv-2 pb-1">
                  <q-btn unelevated type="submit" color="primary" class="capital bg-grad full-width" label="Sign In" icon="login" size="lg" :loading="loading" >
...
<style>
.bg-side {
  background-image: url('../../public/assets/bg-login-4.jpg');
