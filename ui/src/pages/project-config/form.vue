          ...
          <q-card-section>
            <q-form @submit="submit">
              <q-card-section class="row">
                ...
                <div class="col-12 pv ph" >
                  <q-input v-model="dataModel.value" label="value" dense filled square
                  lazy-rules :rules="[
                    val => val !== null && val !== '' || 'value must be filled',
                  ]" />
                </div>

                <div class="col-12 pv ph" >
                  <q-input v-model="dataModel.description" label="description" dense filled square  />
                </div>
...
export default {
  ...
  methods: {
    ...
    backToRoot () {
      this.$router.push({ name: 'project-config', params: { project_id: this.dataModel.project_id } })
    },
