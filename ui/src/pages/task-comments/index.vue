    ...
    return {
      ...
      table: {
        ...
        columns: [
          ...
          { name: 'task_id', label: 'task_id', field: 'task_id', align: 'left' },
          { name: 'description', label: 'description', field: 'description', align: 'left' },
          { name: 'reply', label: 'reply', field: 'reply', align: 'left' },
          { name: 'created_by', label: 'created_by', field: 'created_by', align: 'left' },
          { name: 'updated_by', label: 'updated_by', field: 'updated_by', align: 'left' },
          { name: 'deleted_by', label: 'deleted_by', field: 'deleted_by', align: 'left' }
