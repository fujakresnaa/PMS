      ...
      <div class="q-pa-md">
        ...
        >
          ...
          <template v-slot:body-cell-status="props">
            <q-td :props="props">
              <q-btn size="sm" :label="props.row.status" unelevated rounded class="mv mh capital"
              :color="$Config.colorStatusSprints(props.row.status)" :icon="$Config.iconStatusSprints(props.row.status)" >
                <q-tooltip>Status: {{props.row.status}}</q-tooltip>
              </q-btn>
            </q-td>
          </template>
