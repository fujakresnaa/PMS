...
use App\Validators\ProjectConfigValidator;
use Exception;
...
class ProjectConfigRepositoryEloquent extends BaseRepository implements ProjectConfigRepository
{
    use StandardRepo;
    ...
    public function store($raw_request, $id = null, $customRequest = null) {
        try {
            ...
            $data->value = H_handleRequest($request, 'value'); 
