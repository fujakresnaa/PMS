...
class TaskComponentsController extends Controller
{
    ...
    public function __construct(
        Request $request,
        TaskComponentsRepository $repository
    ){
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'task-components-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'task-components-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'task-components-update');
        else AuthProvider::has($request, 'task-components-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'task-components-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'task-components-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'TaskComponents-'.H_getCurrentDate();
