...
class TaskLabelsController extends Controller
{
    ...
    public function __construct(
        Request $request,
        TaskLabelsRepository $repository
    ){
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'task-labels-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'task-labels-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'task-labels-update');
        else AuthProvider::has($request, 'task-labels-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'task-labels-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'task-labels-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'TaskLabels-'.H_getCurrentDate();
