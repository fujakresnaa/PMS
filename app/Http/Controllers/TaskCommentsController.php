...
class TaskCommentsController extends Controller
{
    ...
    public function __construct(
        Request $request,
        TaskCommentsRepository $repository
    ){
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'task-comments-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'task-comments-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'task-comments-update');
        else AuthProvider::has($request, 'task-comments-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'task-comments-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'task-comments-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'TaskComments-'.H_getCurrentDate();
