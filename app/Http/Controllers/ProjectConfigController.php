...
use App\Repositories\ProjectConfigRepository;
...
class ProjectConfigController extends Controller
{
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'project-config-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'project-config-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'project-config-update');
        else AuthProvider::has($request, 'project-config-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'project-config-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'project-config-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'ProjectConfig-'.H_getCurrentDate();
