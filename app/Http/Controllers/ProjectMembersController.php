...
class ProjectMembersController extends Controller
{
    ...
    public function __construct(
        Request $request,
        ProjectMembersRepository $repository
    ){
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'project-members-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'project-members-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'project-members-update');
        else AuthProvider::has($request, 'project-members-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'project-members-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'project-members-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'ProjectMembers-'.H_getCurrentDate();
