...
class WorkAssigneesController extends Controller
{
    ...
    public function __construct(
        Request $request,
        WorkAssigneesRepository $repository
    ){
    ...
    public function index(Request $request) {
        AuthProvider::has($request, 'work-assignees-browse');
        try {
            $payload = $request->all();
    ...
    public function findById(Request $request, $id) {
        AuthProvider::has($request, 'work-assignees-read');
        try {
    ...
    public function store(Request $request, $id = null) {
        if ($id) AuthProvider::has($request, 'work-assignees-update');
        else AuthProvider::has($request, 'work-assignees-create');
        try {
    ...
    public function restore(Request $request, $id = null) {
        AuthProvider::has($request, 'work-assignees-restore');
        try {
    ...
    public function remove(Request $request, $id) {
        AuthProvider::has($request, 'work-assignees-delete');
        try {
            $payload = $request->all();
    ...
    public function exportCSV($data) {
        ...
        $fileName = 'WorkAssignees-'.H_getCurrentDate();
