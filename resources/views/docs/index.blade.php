...
<html lang="en">
  <head>
    <title>User Documentation | {{$data->name}}</title>
    <meta charset="utf-8">
      ...
      <div class="docs-sidebar off-canvas-sidebar" id="sidebar">
        <div style="padding: 10px 10px 15px 20px;position: fixed;">
            <a class="docs-logo" href="">
                <b>{{$data->name}}</b><br>
                <small class="label label-secondary text-bold">DOCS</small>
            </a>
        </div>
        <!-- Menu -->
        <div class="docs-nav">
      ...
      <div class="off-canvas-content">
        <div class="docs-content" id="content">
          ...
          <div class="docs-footer container grid-lg" id="copyright">
            <p>{{$data->name}} | User Documentation</p>
          </div>
